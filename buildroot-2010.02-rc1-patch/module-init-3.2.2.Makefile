...
#def CONFIG_NO_BACKWARDS_COMPAT 1
...
ACLOCAL = ${SHELL} /home/buildroot-2010.02-rc1/output/toolchain/module-init-tools-3.2.2/missing --run aclocal-1.6
AUTOCONF = ${SHELL} /home/buildroot-2010.02-rc1/output/toolchain/module-init-tools-3.2.2/missing --run autoconf
AUTOMAKE = ${SHELL} /home/buildroot-2010.02-rc1/output/toolchain/module-init-tools-3.2.2/missing --run automake-1.6
AUTOHEADER = ${SHELL} /home/buildroot-2010.02-rc1/output/toolchain/module-init-tools-3.2.2/missing --run autoheader
...
AMTAR = ${SHELL} /home/buildroot-2010.02-rc1/output/toolchain/module-init-tools-3.2.2/missing --run tar
AWK = mawk
CC = /usr/bin/gcc
DEPDIR = .deps
...
am__include = include
am__quote = 
install_sh = /home/buildroot-2010.02-rc1/output/toolchain/module-init-tools-3.2.2/install-sh
...
DEFS = -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE=\"module-init-tools\" -DVERSION=\"3.2.2\" 
...
DEP_FILES = ./$(DEPDIR)/backwards_compat.Po \
	./$(DEPDIR)/depmod.Po ./$(DEPDIR)/insmod.Po \
	./$(DEPDIR)/lsmod.Po ./$(DEPDIR)/modinfo.Po \
	./$(DEPDIR)/modprobe.Po ./$(DEPDIR)/moduleops.Po \
	./$(DEPDIR)/moduleops_core.Po ./$(DEPDIR)/rmmod.Po \
	./$(DEPDIR)/tables.Po ./$(DEPDIR)/zlibsupport.Po
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkinstalldirs) $(distdir)/doc $(distdir)/tests
...
.PHONY: GTAGS all all-am check check-TESTS check-am clean \
	clean-binPROGRAMS clean-generic clean-sbinPROGRAMS dist \
